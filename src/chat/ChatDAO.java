...
public class ChatDAO {
	...
	public int submit(String fromID, String toID, String chatContent){
		...
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String SQL = "INSERT INTO CHAT VALUES (CHAT_ID.NEXTVAL, ?, ?, ?, sysdate, 0)";
		try {
			conn = dataSource.getConnection();
			pstmt = conn.prepareStatement(SQL);
			pstmt.setString(1, fromID);
	...
	public int getAllUnreadChat(String userID) {//현재 읽지않은 모든 메세지 갯수
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	//메시지함안에 자신이 받은 메시지 목록이 출력이 될 수 있도록 메시지함
	...
	public int getUnreadChat(String fromID, String toID) {//현재 읽지않은 모든 메세지 갯수
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
